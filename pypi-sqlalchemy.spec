...
Source0  : https://files.pythonhosted.org/packages/00/8e/e77fcaa67f8b9f504b4764570191e291524575ddbfe78a90fc656d671fdc/sqlalchemy-2.0.39.tar.gz
...
%prep
%setup -q -n sqlalchemy-2.0.39
cd %{_builddir}/sqlalchemy-2.0.39
pushd ..
cp -a sqlalchemy-2.0.39 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741726392
...
cp %{_builddir}/sqlalchemy-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-sqlalchemy/da8d8c0738bed674614e676427fb66204e6869f0 || :
...
/usr/share/package-licenses/pypi-sqlalchemy/da8d8c0738bed674614e676427fb66204e6869f0
