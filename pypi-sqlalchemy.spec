...
Source0  : https://files.pythonhosted.org/packages/e5/07/a928d473438adb98ebd2264f584c4bd2dd711dfe6caf4b1906cba14dd375/SQLAlchemy-2.0.19.tar.gz
...
%prep
%setup -q -n SQLAlchemy-2.0.19
cd %{_builddir}/SQLAlchemy-2.0.19
pushd ..
cp -a SQLAlchemy-2.0.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689614307
