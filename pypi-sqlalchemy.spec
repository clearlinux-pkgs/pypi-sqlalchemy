...
Source0  : https://files.pythonhosted.org/packages/3a/23/cc8844d4873ec0485f961c047ca831040c3ba7ecf9d88ec6f9249e1d1cbe/SQLAlchemy-2.0.28.tar.gz
...
%prep
%setup -q -n SQLAlchemy-2.0.28
cd %{_builddir}/SQLAlchemy-2.0.28
pushd ..
cp -a SQLAlchemy-2.0.28 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709569630
