...
Source0  : https://files.pythonhosted.org/packages/ba/7d/e3312ae374fe7a4af7e1494735125a714a0907317c829ab8d8a31d89ded4/SQLAlchemy-2.0.31.tar.gz
...
%prep
%setup -q -n SQLAlchemy-2.0.31
cd %{_builddir}/SQLAlchemy-2.0.31
pushd ..
cp -a SQLAlchemy-2.0.31 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718824420
