...
Source0  : https://files.pythonhosted.org/packages/3b/20/93ea2518df4d7a14ebe9ace9ab8bb92aaf7df0072b9007644de74172b06c/sqlalchemy-2.0.37.tar.gz
...
%prep
%setup -q -n sqlalchemy-2.0.37
cd %{_builddir}/sqlalchemy-2.0.37
pushd ..
cp -a sqlalchemy-2.0.37 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736522776
