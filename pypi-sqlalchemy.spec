...
Source0  : https://files.pythonhosted.org/packages/22/af/b7b5c4952923cade206d1c1809eeebfdec07096201d7473dd70faa5ffaa1/SQLAlchemy-2.0.2.tar.gz
Source1  : https://files.pythonhosted.org/packages/22/af/b7b5c4952923cade206d1c1809eeebfdec07096201d7473dd70faa5ffaa1/SQLAlchemy-2.0.2.tar.gz.asc
...
%prep
%setup -q -n SQLAlchemy-2.0.2
cd %{_builddir}/SQLAlchemy-2.0.2
pushd ..
cp -a SQLAlchemy-2.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675785933
