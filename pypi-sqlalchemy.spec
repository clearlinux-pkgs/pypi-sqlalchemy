...
Source0  : https://files.pythonhosted.org/packages/99/04/59971bfc2f192e3b52376ca8d1e134c78d04bc044ef7e04cf10c42d2ce17/SQLAlchemy-2.0.29.tar.gz
...
%prep
%setup -q -n SQLAlchemy-2.0.29
cd %{_builddir}/SQLAlchemy-2.0.29
pushd ..
cp -a SQLAlchemy-2.0.29 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711240884
