...
Source0  : https://files.pythonhosted.org/packages/68/c3/3f2bfa5e4dcd9938405fe2fab5b6ab94a9248a4f9536ea2fd497da20525f/sqlalchemy-2.0.40.tar.gz
...
%prep
%setup -q -n sqlalchemy-2.0.40
cd %{_builddir}/sqlalchemy-2.0.40
pushd ..
cp -a sqlalchemy-2.0.40 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743172739
