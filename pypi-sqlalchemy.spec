...
Source0  : https://files.pythonhosted.org/packages/36/d0/0137ebcf0dc230c2e82a621b3af755b8788a2a9dd6fd1b8cd6d5e7f6b00d/SQLAlchemy-2.0.30.tar.gz
...
%prep
%setup -q -n SQLAlchemy-2.0.30
cd %{_builddir}/SQLAlchemy-2.0.30
pushd ..
cp -a SQLAlchemy-2.0.30 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715016252
