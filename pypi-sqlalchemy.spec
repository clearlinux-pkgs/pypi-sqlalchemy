...
Source0  : https://files.pythonhosted.org/packages/36/48/4f190a83525f5cefefa44f6adc9e6386c4de5218d686c27eda92eb1f5424/sqlalchemy-2.0.35.tar.gz
...
%prep
%setup -q -n sqlalchemy-2.0.35
cd %{_builddir}/sqlalchemy-2.0.35
pushd ..
cp -a sqlalchemy-2.0.35 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726581948
