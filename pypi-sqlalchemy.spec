...
Source0  : https://files.pythonhosted.org/packages/63/66/45b165c595ec89aa7dcc2c1cd222ab269bc753f1fc7a1e68f8481bd957bf/sqlalchemy-2.0.41.tar.gz
...
%prep
%setup -q -n sqlalchemy-2.0.41
cd %{_builddir}/sqlalchemy-2.0.41
pushd ..
cp -a sqlalchemy-2.0.41 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747319967
