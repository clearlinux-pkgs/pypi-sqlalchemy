...
Source0  : https://files.pythonhosted.org/packages/2e/da/7bbd282e801fcbd3b1e2182900fb0de106be11c584e645def31fedf2acbf/SQLAlchemy-2.0.16.tar.gz
...
%prep
%setup -q -n SQLAlchemy-2.0.16
cd %{_builddir}/SQLAlchemy-2.0.16
pushd ..
cp -a SQLAlchemy-2.0.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686670115
